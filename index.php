...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-md-offset-4">
                <a href="#" class="pull-right btn sub1" data-toggle="modal" data-target="#myModal"><span
                        ...
                        class="title1"><b>Ingresar</b></span></a>
            </div>
                            ...
                            <form class="form-horizontal" action="login.php?q=index.php" method="POST">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input id="password" name="password" placeholder="Ingresa tu contraseña"
                ...
                <form class="form-horizontal" name="form" action="sign.php?q=account.php"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select id="gender" name="gender" placeholder="Ingresa tu género"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="cpassword" name="cpassword" placeholder="Confirma tu contraseña"
                                    class="form-control input-md" type="password">
    ...
    <div class="modal fade title1" id="developers">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Desarrollador</span>
                    </h4>
                </div>
     ...
     " width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
                        ...
                        <div class="col-md-5">
                            <a href="https://www.configuroweb.com/acerca-de-mi/"
                                style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="Accede a mi sitio web">Federico Rendon Buelvas</a>
                            <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+57 3145961181
                            </h4>
                            <h4 style="font-family:'typo' ">federendon26@hotmail.com</h4>
                        </div>
                    </div>
                    </p>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form role="form" method="post" action="admin.php?q=index.php">
                                <div class="form-group">
                                    <input type="text" name="uname" maxlength="30" placeholder="Usuario Admin"
                                        class="form-control" />
                                </div>
                                <div class="form-group">
                                    <input type="password" name="password" maxlength="15" placeholder="Contraseña Admin"
                                        class="form-control" />
                                </div>
